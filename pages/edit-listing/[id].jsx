...
export default function EditListing() {
  ...
  const [originalImages, setOriginalImages] = useState([]); // Track original images
    ...
    const fetchListing = async () => {
      try {
        ...
        if (listingSnap.exists()) {
          ...
          // Handle images
          const existingImages = data.photos || (data.photo ? [data.photo] : []);
        ...
        <div className="w-full max-w-2xl md:max-w-4xl">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Categories - Always show in edit mode */}
              <motion.div
